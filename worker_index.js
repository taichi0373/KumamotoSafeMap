// const url_index = "https://uemura-taichi.com/server/server_index.php";
const url_index = "./server/server_index.php";
        ...
        for (const coord of coordinates) {
          ...
          const popup = `
            ...
            coord.injury_degree_b
                                              ...
                                              <button type="button" class="btn btn-dark" onclick='showPage(2, ${coord.id
                                            ...
                                            <div id='page-2' style='display: none; width:100%; height:400px;'>
                                              ...
                                              <div class="form-comments" style="width:100%; height: auto;">
                                                ...
                                                <button type="button" class="btn btn-dark me-2" onclick='showPage(1)' style="width:80px;">戻る</button>
                                                <button id="comment-submit" onclick='submitComment(${coord.id}, ${coord.latitude}, ${coord.longitude})' type="button" class="btn btn-primary" style="width:80px;">書き込む</button>
                                              </div>
                                            </div>
                                        </div>
                                          `;
